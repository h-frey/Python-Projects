...
currency_from= input("Enter the currency you would like to convert from: ").upper()
currency_to = input("Enter the currency you would like to convert to: ").upper()
amount = int(input("Enter the amount you would like to convert: "))
...
if currency_from in rates.keys() and currency_to in rates.keys():
    ...
    print()
    print("{} {} = {} USD".format(amount,currency_from, final_amount))
    print()
else:
    print("not in ")
